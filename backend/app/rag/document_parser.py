...
class DocumentParser:
    ...
    def parse_markdown(file_path: str) -> Tuple[str, Dict[str, Any]]:
        ...
        metadata = {"format": "markdown", "html_length": len(html)}
    ...
    def parse_text(file_path: str) -> Tuple[str, Dict[str, Any]]:
        ...
        metadata = {"format": "text", "lines": text.count("\n") + 1}
    ...
    def parse_jsonl(file_path: str) -> Tuple[str, Dict[str, Any]]:
        ...
        metadata = {"format": "jsonl", "lines": len(lines)}
    ...
    def parse_yaml(file_path: str) -> Tuple[str, Dict[str, Any]]:
        ...
        with open(file_path, "r", encoding="utf-8") as f:
            try:
                ...
                metadata = {"format": "yaml", "keys": keys}
                ...
                f.seek(0)
                text = f.read()
                metadata = {"format": "yaml", "parse_error": str(e)}
                return text, metadata
